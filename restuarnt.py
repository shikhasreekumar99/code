...
txtKesari=Entry(f1, font=('arial',16,'bold'),textvariable=Kesari,bd=10,insertwidth=4,bg="white",justify='right')
...
txtKarabath=Entry(f1, font=('arial',16,'bold'),textvariable=Karabath,bd=10,insertwidth=4,bg="white",justify='right')
...
btnExit=Button(f1,padx=16,pady=8,bd=16,fg="black",font=('arial',16,'bold'),width=10,text="Exit",bg="white",command=qExit).grid(row=7,column=3)
